# -*- coding: utf-8 -*-
"""
Created on Mon Feb 10 15:01:40 2025
...
root.title("Intrustion Detection using ml")
...
#
label_l1 = tk.Label(root, text="Intrustion Detection using ml",font=("Times New Roman", 30, 'bold underline'),
...
button1 = tk.Button(root, text="Admin", command=log,width=14, height=1,font=('times', 20, ' bold '), bg="white", fg="black")
button1.place(x=100, y=160)

button2 = tk.Button(root, text="User",command=reg,width=14, height=1,font=('times', 20, ' bold '), bg="white", fg="black")
