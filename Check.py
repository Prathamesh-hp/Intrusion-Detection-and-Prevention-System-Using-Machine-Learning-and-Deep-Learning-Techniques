...
def Train():
    ...
    def send_email_alert(subject, body):
        ...
        app_password = "shlr cpxr wcxj gvit"  # Use an App Password
    ...
    def Detect():
        ...
        a1=load('C:/Users/Trupti/Downloads/attack_NaiveBayes/attack_RandomForest.joblib')
        ...
        if v[0]==1:
            ...
            print("Intrusion")
            msg = "An Intrusion attack has been detected in your system."
            # Run email sending in a separate thread
            threading.Thread(target=send_email_alert, args=("🚨 Intrusion Alert!", msg), daemon=True).start()
